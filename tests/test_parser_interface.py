...
EXPECTED_MODE_FUNCTION_ARGS = {
    ...
    "maxExchangesDayAhead": _EXCHANGE_FUNCTION_ARGS,
    "scheduledExchangesDayAhead": _EXCHANGE_FUNCTION_ARGS,
    "maxBorderFlowDayAhead": _EXCHANGE_FUNCTION_ARGS,
...
EXPECTED_MODE_RETURN_ANNOTATIONS = {
    ...
    "maxExchangesDayAhead": _RETURN_PARSER_TYPE,
    "scheduledExchangesDayAhead": _RETURN_PARSER_TYPE,
    "maxBorderFlowDayAhead": _RETURN_PARSER_TYPE,
