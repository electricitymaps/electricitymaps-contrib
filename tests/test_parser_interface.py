...
EXPECTED_MODE_FUNCTION_ARGS = {
    ...
    "shadowAuctionAtc": _EXCHANGE_FUNCTION_ARGS,
    "coreExternalAtc": _EXCHANGE_FUNCTION_ARGS,
    "maxExchanges": _EXCHANGE_FUNCTION_ARGS,
    "scheduledExchanges": _EXCHANGE_FUNCTION_ARGS,
    "maxBorderFlow": _EXCHANGE_FUNCTION_ARGS,
...
EXPECTED_MODE_RETURN_ANNOTATIONS = {
    ...
    "shadowAuctionAtc": _RETURN_PARSER_TYPE,
    "coreExternalAtc": _RETURN_PARSER_TYPE,
    "maxExchanges": _RETURN_PARSER_TYPE,
    "scheduledExchanges": _RETURN_PARSER_TYPE,
    "maxBorderFlow": _RETURN_PARSER_TYPE,
