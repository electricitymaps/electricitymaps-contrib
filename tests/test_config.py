...
class ConfigTestcase(unittest.TestCase):
    def test_ZONE_NEIGHBOURS(self):
        ...
        self.assertGreater(len(dk_neighbours), 1, 'expected a few neighbours for DK-DK1')
        self.assertEqual(sorted(dk_neighbours), dk_neighbours, 'neighbours should be sorted')
