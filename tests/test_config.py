...
class ConfigTestcase(unittest.TestCase):
    def test_zones_config(self):
        ...
        self.assertIn("bounding_box", config.ZONES_CONFIG["DK-DK1"].keys())
        self.assertIn("capacity", config.ZONES_CONFIG["DK-DK1"].keys())
    ...
    def test_zone_parent(self):
        ...
        self.assertEqual(config.ZONE_PARENT["DK-DK1"], "DK")
    ...
    def test_zone_bounding_box(self):
        ...
        self.assertEqual(len(config.ZONE_BOUNDING_BOXES["DK-DK1"]), 2)
    ...
    def test_emission_factors(self):
        ...
        factors = config.emission_factors("DK-DK1")
