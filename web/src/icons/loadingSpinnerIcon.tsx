...
export const LoadingSpinnerIcon = memo(function LoadingSpinnerIcon() {
  return (
    <div className="text-black dark:text-white">
      ...
      >
        <AnimatedCircle cx="420" cy="420" begin="0s" />
        <AnimatedCircle cx="256" cy="420" begin="0.1s" />
        <AnimatedCircle cx="92" cy="420" begin="0.2s" />
        <AnimatedCircle cx="420" cy="256" begin="0.3s" />
        <AnimatedCircle cx="92" cy="256" begin="0.4s" />
        <AnimatedCircle cx="420" cy="92" begin="0.5s" />
        <AnimatedCircle cx="256" cy="92" begin="0.6s" />
        <AnimatedCircle cx="92" cy="92" begin="0.7s" />
        <path
