...
var Windy = function (params: any) {
  var VELOCITY_SCALE = 1 / 50000; //1/70000             // scale for wind velocity (completely arbitrary--this value looks nice)
  ...
  var interpolateField = function (
    ...
    var velocityScale = bounds.height * VELOCITY_SCALE * zoomScaling();
  ...
  var animate = function (
    ...
    var particleCount = Math.round(bounds.width * PARTICLE_MULTIPLIER * zoomScaling());
    if (isMobile()) {
