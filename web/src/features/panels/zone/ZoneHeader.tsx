...
function OutageMessage({
  ...
  return (
    <div className="pl-4">
      <div className="w-full rounded-lg border border-yellow-300 bg-yellow-100 p-2 text-sm">
        <p className="break-all">
          ⚠️ {truncateString(outageData.message, 300)}{' '}
          {outageData?.issue && outageData.issue != 'None' && (
            <p className="inline-flex">
              ...
              >
                ...
                <p className="pl-1 text-blue-600 underline">
                  on this issue (#{outageData.issue.split('.')[0]})
                </p>
              </a>
            </p>
          )}
