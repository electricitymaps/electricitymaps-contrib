...
function OuterPanel({ children }: { children: React.ReactNode }) {
  ...
  return (
    <aside
      ...
      className={`absolute left-0 top-0 z-20 h-full w-full  bg-zinc-50 shadow-xl transition-all duration-500 sm:flex sm:w-[calc(14vw_+_18rem)] dark:bg-gray-900 dark:[color-scheme:dark] ${
