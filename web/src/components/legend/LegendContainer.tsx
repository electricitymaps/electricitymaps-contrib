...
export default function LegendContainer(): ReactElement {
  ...
  return (
    <div className="invisible fixed bottom-4 right-4 z-20 flex w-[224px] flex-col rounded bg-white/90 px-1 py-2 shadow-xl backdrop-blur-sm sm:visible dark:bg-gray-800">
