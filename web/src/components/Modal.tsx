    ...
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed left-[50%] top-[50%] z-40 w-[98vw] max-w-2xl -translate-x-[50%] -translate-y-[50%] rounded-xl bg-white/90 p-4 shadow-md backdrop-blur-sm dark:bg-gray-800/95 sm:w-[90vw]"
        >
