...
test('Exchange data is fetched', () => {
  ...
  expect(state.exchanges['DE->DK-DK1'].data).toHaveLength(0);
  ...
  expect(state.exchanges['DE->DK-DK1'].data).toHaveLength(25);
  expect(state.exchanges['DE->DK-DK1'].data[0]).toMatchObject(expectedExchange);
});
