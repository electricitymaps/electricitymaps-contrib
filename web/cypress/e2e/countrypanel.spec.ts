...
describe('Country Panel', () => {
  ...
  it.skip('asserts countryPanel contains "no-recent-data" message', () => {
    cy.interceptAPI('v10/details/hourly_72/UA');
    ...
    cy.waitForAPISuccess('v10/state/hourly_72');
    cy.waitForAPISuccess('v10/details/hourly_72/UA');
  ...
  it('asserts countryPanel contains no parser message when zone has no data', () => {
    ...
    cy.interceptAPI('v10/state/hourly_72');
    cy.interceptAPI('v10/details/hourly_72/CN');
    cy.interceptAPI('v10/meta'); // Add this if needed
    ...
    cy.waitForAPISuccess('v10/state/hourly_72');
    cy.waitForAPISuccess('v10/details/hourly_72/CN');
