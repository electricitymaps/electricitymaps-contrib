...
exports.addCountryTopos = function(countries) {
  ...
  // countries['ESC-LP'] = getCountry('La Palma')
  // countries['ESC-HI'] = getCountry('Hierro')
  // countries['ESC-IG'] = getCountry('Isla de la Gomera')
  // countries['ESC-TE'] = getCountry('Tenerife')
  // countries['ESC-GC'] = getCountry('Gran Canaria')
  // countries['ESC-FV'] = getCountry('Fuerteventura')
  // countries['ESC-LZ'] = getCountry('Lanzarote')
