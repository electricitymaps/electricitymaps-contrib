...
const thirdpartyGeos = readNDJSON('./build/tmp_thirdparty.json').concat([
    ...
    JSON.parse(fs.readFileSync('./third_party_maps/FR-ARA.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-BFC.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-BRE.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-CVL.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-GES.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-HDF.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-IDF.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-NAQ.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-NOR.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-OCC.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-PAC.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/FR-PDL.geojson')),
  ]);
...
const zoneDefinitions = [
  ...
  { zoneName: 'FR-IDF', type: 'subZone', id: 'FR-IDF' },
  { zoneName: 'FR-NAQ', type: 'subZone', id: 'FR-NAQ' },
  { zoneName: 'FR-NOR', type: 'subZone', id: 'FR-NOR' },
