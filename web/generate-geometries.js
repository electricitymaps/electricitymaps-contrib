...
const zoneDefinitions = [
  ...
  {zoneName: 'US-PEC', type: 'country', id: 'POWERSOUTH ENERGY COOPERATIVE'},
  {zoneName: 'US-BPA', type: 'country', id: 'BONNEVILLE POWER ADMINISTRATION'},
  //{zoneName: 'US-CA', type: 'country', id: 'CALIFORNIA INDEPENDENT SYSTEM OPERATOR'},
  {zoneName: 'US-AECI', type: 'country', id: 'ASSOCIATED ELECTRIC COOPERATIVE, INC.'},
  {zoneName: 'US-AC', type: 'country', id: 'AVISTA CORPORATION'},
  {zoneName: 'US-APSC', type: 'country', id: 'ARIZONA PUBLIC SERVICE COMPANY'},
  //{zoneName: 'US-BANC', type: 'country', id: 'BALANCING AUTHORITY OF NORTHERN CALIFORNIA'},
  {zoneName: 'US-PUD1CC', type: 'country', id: 'PUBLIC UTILITY DISTRICT NO. 1 OF CHELAN COUNTY'},
  {zoneName: 'US-PECE', type: 'country', id: 'PROGRESS ENERGY CAROLINAS - EAST'},
  {zoneName: 'US-PUD1DC', type: 'country', id: 'PUD NO. 1 OF DOUGLAS COUNTY'},
  {zoneName: 'US-DEC', type: 'country', id: 'DUKE ENERGY CAROLINAS'},
  {zoneName: 'US-EEI', type: 'country', id: 'ELECTRIC ENERGY, INC.'},
  {zoneName: 'US-EPEC', type: 'country', id: 'EL PASO ELECTRIC COMPANY'},
  {zoneName: 'US-FMPP', type: 'country', id: 'FLORIDA MUNICIPAL POWER POOL'},
  {zoneName: 'US-PEF', type: 'country', id: 'PROGRESS ENERGY FLORIDA'},
  {zoneName: 'US-FPLC', type: 'country', id: 'FLORIDA POWER & LIGHT COMPANY'},
  {zoneName: 'US-PUD2GCW', type: 'country', id: 'PUBLIC UTILITY DISTRICT NO. 2 OF GRANT COUNTY, WASHINGTON'},
  {zoneName: 'US-GRU', type: 'country', id: 'GAINESVILLE REGIONAL UTILITIES'},
  {zoneName: 'US-COH', type: 'country', id: 'CITY OF HOMESTEAD'},
  //{zoneName: 'US-IID', type: 'country', id: 'IMPERIAL IRRIGATION DISTRICT'},
  {zoneName: 'US-IPC', type: 'country', id: 'IDAHO POWER COMPANY'},
  {zoneName: 'US-NEISO', type: 'countries', countries: ['ISO NEW ENGLAND INC.', 'NEW BRUNSWICK SYSTEM OPERATOR']},
  {zoneName: 'US-JEA', type: 'country', id: 'JEA'},
  //{zoneName: 'US-LADWP', type: 'country', id: 'LOS ANGELES DEPARTMENT OF WATER AND POWER'},
  {zoneName: 'US-LGECKI', type: 'country', id: 'LOUISVILLE GAS AND ELECTRIC COMPANY AND KENTUCKY UTILITIES'},
  {zoneName: 'US-MISO', type: 'country', id: 'MIDCONTINENT INDEPENDENT TRANSMISSION SYSTEM OPERATOR, INC..'},
  {zoneName: 'US-NPC', type: 'country', id: 'NEVADA POWER COMPANY'},
  {zoneName: 'US-NSB', type: 'country', id: 'NEW SMYRNA BEACH, UTILITIES COMMISSION OF'},
  {zoneName: 'US-NWMT', type: 'country', id: 'NORTHWESTERN ENERGY (NWMT)'},
  {zoneName: 'US-NY', type: 'country', id: 'NEW YORK INDEPENDENT SYSTEM OPERATOR'},
  {zoneName: 'US-PEAST', type: 'country', id: 'PACIFICORP - EAST'},
  {zoneName: 'US-PGEC', type: 'country', id: 'PORTLAND GENERAL ELECTRIC COMPANY'},
  {zoneName: 'US-PJM', type: 'country', id: 'PJM INTERCONNECTION, LLC'},
  {zoneName: 'US-PSCNM', type: 'country', id: 'PUBLIC SERVICE COMPANY OF NEW MEXICO'},
  {zoneName: 'US-PSCC', type: 'country', id: 'PUBLIC SERVICE COMPANY OF COLORADO'},
  {zoneName: 'US-PSE', type: 'country', id: 'PUGET SOUND ENERGY'},
  {zoneName: 'US-SCPSA', type: 'country', id: 'SOUTH CAROLINA PUBLIC SERVICE AUTHORITY'},
  {zoneName: 'US-SCEGC', type: 'country', id: 'SOUTH CAROLINA ELECTRIC & GAS COMPANY'},
  {zoneName: 'US-SCL', type: 'country', id: 'SEATTLE CITY LIGHT'},
  {zoneName: 'US-SEC', type: 'country', id: 'SEMINOLE ELECTRIC COOPERATIVE'},
  {zoneName: 'US-SEPA', type: 'country', id: 'SOUTHEASTERN POWER ADMINISTRATION'},
  {zoneName: 'US-SCS', type: 'country', id: 'SOUTHERN COMPANY SERVICES, INC. - TRANS'},
  {zoneName: 'US-SPA', type: 'country', id: 'SOUTHWESTERN POWER ADMINISTRATION'},
  {zoneName: 'US-SRP', type: 'country', id: 'SALT RIVER PROJECT'},
  //{zoneName: 'US-SPP', type: 'country', id: 'SOUTHWEST POWER POOL'},
  {zoneName: 'US-COT', type: 'country', id: 'CITY OF TALLAHASSEE'},
  {zoneName: 'US-TEC', type: 'country', id: 'TAMPA ELECTRIC COMPANY'},
  {zoneName: 'US-TEPC', type: 'country', id: 'TUCSON ELECTRIC POWER COMPANY'},
  //{zoneName: 'US-TID', type: 'country', id: 'TURLOCK IRRIGATION DISTRICT'},
  {zoneName: 'US-COTDPU', type: 'country', id: 'CITY OF TACOMA, DEPARTMENT OF PUBLIC UTILITIES, LIGHT DIVISION'},
  {zoneName: 'US-TVA', type: 'country', id: 'TENNESSEE VALLEY AUTHORITY'},
  {zoneName: 'US-WAPARMR', type: 'country', id: 'WESTERN AREA POWER ADMINISTRATION - ROCKY MOUNTAIN REGION'},
  {zoneName: 'US-WAPAW', type: 'country', id: 'WESTERN AREA POWER ADMINISTRATION UGP WEST'},
  {zoneName: 'US-CECD', type: 'country', id: 'CONSTELLATION ENERGY CONTROL AND DISPATCH, LLC'},
  {zoneName: 'US-AVBA', type: 'country', id: 'ARLINGTON VALLEY, LLC - AVBA'},
  {zoneName: 'US-GEL', type: 'country', id: 'GRIFFITH ENERGY, LLC'},
  {zoneName: 'US-GRP', type: 'country', id: 'GILA RIVER POWER, LLC'},
  {zoneName: 'US-NPW', type: 'country', id: 'NATURENER POWER WATCH, LLC (GWA)'},
  {zoneName: 'US-NHGC', type: 'country', id: 'NEW HARQUAHALA GENERATING COMPANY, LLC - HGBA'},
  {zoneName: 'US-OVEC', type: 'country', id: 'OHIO VALLEY ELECTRIC CORPORATION'},
  {zoneName: 'US-NWW', type: 'country', id: 'NATURENER WIND WATCH, LLC'},
  {zoneName: 'US-APG', type: 'country', id: 'ALCOA POWER GENERATING, INC. - YADKIN DIVISION'},
  {zoneName: 'US-WAPADSR', type: 'country', id: 'WESTERN AREA POWER ADMINISTRATION - DESERT SOUTHWEST REGION'},
  {zoneName: 'US-PWEST', type: 'country', id: 'PACIFICORP - WEST'},
  ...
  {zoneName: 'US-LADWP', type: 'country', id: 'LOS ANGELES DEPARTMENT OF WATER AND POWER'},
  {zoneName: 'US-TID', type: 'country', id: 'TURLOCK IRRIGATION DISTRICT'},
  {zoneName: 'US-ERCOT', type: 'country', id: 'ELECTRIC RELIABILITY COUNCIL OF TEXAS, INC.'},
