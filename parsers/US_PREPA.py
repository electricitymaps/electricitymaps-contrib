...
GENERATION_BREAKDOWN_URL = (
    "https://aeepr.com/es-pr/generacion/Documents/combustibles.aspx"
)
RENEWABLES_BREAKDOWN_URL = (
    "https://aeepr.com/es-pr/generacion/Documents/Unidades_renovables.aspx"
)
...
def fetch_production(
    ...
    raw_timestamp = re.search(
        r"Ultima Actualización:  ((?:0[1-9]|1[0-2])/(?:[0-2][0-9]|3[0-2])/2[01][0-9]{2}  [0-2][0-9]:[0-5][0-9]:[0-5][0-9] [AP]M)",
        res.text,
    ).group(
        1
    )  # Extract timestamp
