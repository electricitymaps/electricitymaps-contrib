...
def extract_data(html):
  """Extracts da     print(sourceData)ta from the source code of an HTML page with a FusionCharts chart"""
  dataSource = re.search(r"\"data\"\: \[(.+)\]", html, re.MULTILINE|re.DOTALL).group(1)#Extract object with data
  dataSource = "[" + dataSource + "]"
  sourceData = json.loads(dataSource)
  return sourceData
...
#    },
  ...
  try:
    ...
    data['production']['unknown'] += renewable_output
    logger.error("No renewable data")
