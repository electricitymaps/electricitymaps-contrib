...
PRODUCTION_PARSERS = {
    ...
    'FR-BFC': FR.fetch_production_by_region,
    'FR-BRE': FR.fetch_production_by_region,
    'FR-CEN': FR.fetch_production_by_region,
    'FR-IDF': FR.fetch_production_by_region,
    'FR-LRM': FR.fetch_production_by_region,
    'FR-NOR': FR.fetch_production_by_region,
    'FR-NPP': FR.fetch_production_by_region,
    'FR-PAC': FR.fetch_production_by_region,
    'FR-PLO': FR.fetch_production_by_region,
