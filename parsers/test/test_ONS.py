...
@pytest.mark.parametrize("data_file", ["BR.json", "BR_negative_solar.json", "data.json"])
...
def test_snapshot_fetch_exchange(zone_key1, zone_key2, data_file, adapter, session, snapshot):
