...
struct ViewSizeTimelineProvider: IntentTimelineProvider {
    ...
    func getSnapshot(for configuration: CustomWidgetConfIntent, in context: Context, completion: @escaping (Entry) -> ()) {
    ...
    func getTimeline(for configuration: CustomWidgetConfIntent,
