...
Cross-border transmission capacities between the zones are centralized in the [exchanges](https://github.com/electricitymaps/electricitymaps-contrib/tree/master/config/exchanges) files. Capacities are included in the respective exchange configurations. Values in the `capacity` maps are in MW.
