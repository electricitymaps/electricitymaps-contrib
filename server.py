...
def vendor_GET(path): return flask.send_from_directory('public/vendor', path)
@app.route('/app/<path:path>', methods=['GET', 'OPTIONS'])
def app_GET(path): return flask.send_from_directory('public/app', path)
@app.route('/<path:filename>')
def public_GET(filename): return flask.send_from_directory('public', filename)

@app.route('/')
def index_GET(): return flask.send_from_directory('public', 'index.html')
