...
MAX_EXCHANGES_DAY_AHEAD_PARSERS = {}
SCHEDULED_EXCHANGES_DAY_AHEAD_PARSERS = {}
MAX_BORDER_FLOW_DAY_AHEAD_PARSERS = {}
PRICE_PARSERS = {}
...
PARSER_DATA_TYPE_TO_DICT = {
    ...
    ParserDataType.MAX_EXCHANGES_DAY_AHEAD: MAX_EXCHANGES_DAY_AHEAD_PARSERS,
    ParserDataType.SCHEDULED_EXCHANGES_DAY_AHEAD: SCHEDULED_EXCHANGES_DAY_AHEAD_PARSERS,
    ParserDataType.MAX_BORDER_FLOW_DAY_AHEAD: MAX_BORDER_FLOW_DAY_AHEAD_PARSERS,
