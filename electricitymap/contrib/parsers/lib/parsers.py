...
GRID_ALERTS_PARSERS = {}
INTRADAY_CONTRACT_STATISTICS_PARSERS = {}
# TODO remove
...
PARSER_DATA_TYPE_TO_DICT = {
    ...
    ParserDataType.ATC_DAY_AHEAD: ATC_DAY_AHEAD_PARSERS,
    ...
    ParserDataType.SCHEDULED_EXCHANGES_TOTAL: SCHEDULED_EXCHANGES_TOTAL_PARSERS,
    ...
    ParserDataType.PRICE_EXAA: PRICE_EXAA_PARSERS,
    ...
    ParserDataType.INTRADAY_CONTRACT_STATISTICS: INTRADAY_CONTRACT_STATISTICS_PARSERS,
}
