...
EXCHANGE_SHADOW_AUCTION_ATC_DAY_AHEAD_PARSERS = {}
EXCHANGE_CORE_EXTERNAL_ATC_DAY_AHEAD_PARSERS = {}
EXCHANGE_MAX_EXCHANGES_DAY_AHEAD_PARSERS = {}
EXCHANGE_SCHEDULED_COMMERCIAL_DAY_AHEAD_PARSERS = {}
EXCHANGE_MAX_BORDER_FLOW_DAY_AHEAD_PARSERS = {}
PRICE_PARSERS = {}
...
PARSER_DATA_TYPE_TO_DICT = {
    ...
    ParserDataType.EXCHANGE_SHADOW_AUCTION_ATC_DAY_AHEAD: EXCHANGE_SHADOW_AUCTION_ATC_DAY_AHEAD_PARSERS,
    ParserDataType.EXCHANGE_CORE_EXTERNAL_ATC_DAY_AHEAD: EXCHANGE_CORE_EXTERNAL_ATC_DAY_AHEAD_PARSERS,
    ParserDataType.EXCHANGE_MAX_EXCHANGES_DAY_AHEAD: EXCHANGE_MAX_EXCHANGES_DAY_AHEAD_PARSERS,
    ParserDataType.EXCHANGE_SCHEDULED_COMMERCIAL_DAY_AHEAD: EXCHANGE_SCHEDULED_COMMERCIAL_DAY_AHEAD_PARSERS,
    ParserDataType.EXCHANGE_MAX_BORDER_FLOW_DAY_AHEAD: EXCHANGE_MAX_BORDER_FLOW_DAY_AHEAD_PARSERS,
