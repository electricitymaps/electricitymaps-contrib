...
SHADOW_AUCTION_ATC_PARSERS = {}
CORE_EXTERNAL_ATC_PARSERS = {}
MAX_EXCHANGES_PARSERS = {}
SCHEDULED_EXCHANGES_PARSERS = {}
MAX_BORDER_FLOW_PARSERS = {}
PRICE_PARSERS = {}
...
PARSER_DATA_TYPE_TO_DICT = {
    ...
    ParserDataType.SHADOW_AUCTION_ATC: SHADOW_AUCTION_ATC_PARSERS,
    ParserDataType.CORE_EXTERNAL_ATC: CORE_EXTERNAL_ATC_PARSERS,
    ParserDataType.MAX_EXCHANGES: MAX_EXCHANGES_PARSERS,
    ParserDataType.SCHEDULED_EXCHANGES: SCHEDULED_EXCHANGES_PARSERS,
    ParserDataType.MAX_BORDER_FLOW: MAX_BORDER_FLOW_PARSERS,
